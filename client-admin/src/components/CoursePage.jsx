...
function CoursePage() {
  ...
  useEffect(() => {
    axios
      .get(`https://course-server-tquv.onrender.com/users/courses/${id}`, {
        headers: {
    ...
    axios
      .get("https://course-server-tquv.onrender.com/users/purchasedCourses", {
        headers: {
          Authorization: "Bearer " + localStorage.getItem("token"),
        },
      })
          ...
          {!isPurchased ? (
            <Button
              ...
              onClick={() => {
                axios
                  .post(
                    `https://course-server-tquv.onrender.com/users/courses/${id}`,
                    {},
                    {
                      headers: {
                        Authorization:
